...
https://dev.axiomide.com/marketplace/christiangeorgelucas/unit-tools@0.3.1
...
```bash
axiom invoke christiangeorgelucas/unit-tools/Parse --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/unit-tools/0.3.1/Parse \
...
> `axiom inspect node christiangeorgelucas/unit-tools/Parse`.
